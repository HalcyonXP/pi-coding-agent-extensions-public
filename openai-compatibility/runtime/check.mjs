...
for (const file of ["host", "worker", "protocol", "engine", "evaluator", "rpc-host", "rpc-worker", "rpc-protocol", "windows-host", "native/artifact", "native/build", "cell-input", "cell-bootstrap", "cell-protocol", "cell-worker", "cells", "sync-channel"]) {

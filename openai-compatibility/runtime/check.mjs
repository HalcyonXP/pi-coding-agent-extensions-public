...
for (const file of ["host", "worker", "protocol", "engine", "evaluator", "rpc-host", "rpc-worker", "rpc-protocol", "windows-host", "native/artifact", "native/build", "cell-input", "cell-bootstrap", "image-input", "tool-result-projection", "web-result", "imagegen-result", "evidence", "cell-protocol", "cell-worker", "cells", "sync-channel"]) {

...
1. Native freeform input is implemented through existing Pi APIs as described separately, subject to fresh source/artifact acceptance. Direct-format versus nested-projection adaptation remains; retain existing response consumers until its tested compatibility transition is accepted.

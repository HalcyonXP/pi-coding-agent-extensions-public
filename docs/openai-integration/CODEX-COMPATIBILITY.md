...
| Code mode | Raw-JavaScript custom grammar, wait fields, description-level helper catalog and tool-specific projections are now pinned. Runtime/helper implementation, notification ordering, freeform transport and lifecycle adaptation remain work. Preserve restricted coordination, native delegation, original cell ownership and confirmed cleanup. |

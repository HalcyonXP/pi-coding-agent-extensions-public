...
const suites = Object.freeze({
  ...
  "notice-coverage": tests("distribution/test/supplemental-notices.test.mjs", "distribution/test/runtime-notices.test.mjs", "distribution/test/inventory.test.mjs", "distribution/test/patch-license.test.mjs"),

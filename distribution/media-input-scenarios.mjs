 ...
 try{
  ...
  for(const provider of ['openai','openai-codex']){
   ...
   for(const scenario of scenarios){
    ...
    else if(scenario==='url')code='let reads=0;for(const key of ["type","mimeType","ref"]){const value={type:"image_reference",mimeType:"image/png",ref:"img_11111111-1111-1111-1111-111111111111"};Object.defineProperty(value,key,{get(){reads++;throw Error("image accessor executed");}});try{image(value)}catch{}}if(reads!==0)throw Error("image selector invoked guest getters");image("https://invalid.example/PRIVATE_MEDIA_VALUE.png");';
